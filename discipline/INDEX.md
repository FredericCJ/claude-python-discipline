...
202 rules across 16 modules. Grep this file for a rule id, then open only the module that owns it.
...
14 of 166 binding rules lack an available declared strategy. 61 of 166 rules with automated strategies have inherited rule-level rejection evidence. 164 strategy claims are explicitly proxy claims. `enforce/ENFORCEMENT.md` expands the complete evidence ledger.
...
| [law/OPS](law/OPS.md) | law | 507 | 2 | capability manifest, operational behavior, subprocess lifecycle, network io, persistent state, generated artifact |
